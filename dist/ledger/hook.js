...
exports.runLedgerHook = runLedgerHook;
const path = __importStar(require("node:path"));
const canon_1 = require("../canon");
const append_1 = require("./append");
const command_kind_1 = require("./command-kind");
...
function hashToolField(value) {
    if (typeof value === "string")
        return (0, canon_1.sha256hex)(value);
    return (0, canon_1.canonicalHash)(value ?? {});
}
...
function bashCommandTextFrom(toolInput) {
...
function runLedgerHook(params) {
    ...
    const commandKind = toolName === "Bash" ? (0, command_kind_1.classifyCommandKind)(bashCommandTextFrom(payload.tool_input)) : undefined;
    try {
        const result = (0, append_1.appendEvent)(ledgerPath, {
            ...
            actor: { kind: "MODEL", id: typeof payload.agent_id === "string" ? payload.agent_id : "agent:00000000000000000000000000000000" },
            body: {
                tool_name: toolName,
