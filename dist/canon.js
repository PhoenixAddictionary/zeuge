...
function isJsonUnrepresentable(v) {
...
function canonicalizeValue(v) {
    ...
    if (typeof v === "number") {
        if (!Number.isFinite(v))
            throw new Error("canon: non-finite number cannot be canonicalised");
    ...
    if (isJsonUnrepresentable(v))
        return "null"; // only reachable for a top-level call
    if (typeof v === "object") {
        const obj = v;
